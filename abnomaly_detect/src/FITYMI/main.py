...
def main(args):
    ...
    print(f'device {device} Dataset: {args.dataset}, Normal Label: {args.label}')
    ...
    if not args.load_model:
        ...
        load_model(model, os.path.join(args.output_dir, f'{args.backbone}_{args.dataset}_{args.label}.npy'))
        evaluate_model(args, model, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--all_label', action='store_true',
                        help="Use all label as clean data")
