...
def eval_model(model, train_loader, test_loader, train_loader_1, device, args):
    model.eval()
...
def main(args):
    ...
    model.load_state_dict(torch.load("msad.pt"))
    train_loader, test_loader, train_loader_1 = utils.get_alllabel_loaders(dataset=args.dataset, batch_size=args.batch_size, backbone=args.backbone)
    eval_model(model, train_loader, test_loader, train_loader_1, device, args)
